    ...
    return (
        <div className='relative'>
            <div className=' min-w-full'>
                <div style={{ marginTop: "-2rem" }} className='absolute w-24 ml-14' >
                    <img src= { point } alt="point" />
                </div>
            <div className=' border-gray-200 text-white px-8 m-16 py-6  bg-gradient-to-r from-blue-400 flex justify-between dark:text-gray-900'>
